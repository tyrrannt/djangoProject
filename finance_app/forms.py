...
class CreditAgreementForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['bank', 'contract_number', 'contract_date', 'amount', 'interest_rate', 'has_unused_limit_commission', 'unused_limit_commission_rate', 'credit_end_date', 'availability_period_end', 'tranche_repayment_days', 'employee']
