    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='hrdepartment_app.officialmemo',
                                      verbose_name='Документ')),
                ('person_agreement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                       related_name='person_agreement', to=settings.AUTH_USER_MODEL,
                                                       verbose_name='Согласующее лицо')),
                ('person_department_staff', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                              related_name='person_department_staff',
                                                              to=settings.AUTH_USER_MODEL,
                                                              verbose_name='Сотрудник ОК')),
                ('person_distributor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
