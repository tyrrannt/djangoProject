    ...
    def clean(self):
        ...
        match official_memo_type:
            ...
            case '2':
                ...
                if period_from < self.date_difference(25) or period_for < self.date_difference(25):
                    raise forms.ValidationError(f"Нельзя использовать прошедшую дату! Допустимый период 25 дней. Минимальная дата {self.date_difference(25).strftime('%d.%m.%Y')} г.")
            case '3':
