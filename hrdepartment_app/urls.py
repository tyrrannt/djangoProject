...
urlpatterns = [
    ...
    path('report/year-xls/<int:year>/', ReportCardDetailYearXLS.as_view(), name='reportcard_detail_year_xls'),
    ...
    path('provisions/<int:pk>/delete/', views.ProvisionsDelete.as_view(), name='provisions_delete'),
    ...
    path('labor_protection/', LaborProtectionList.as_view(), name='labor_protection_list'),
    path('labor_protection/add/', LaborProtectionAdd.as_view(), name='labor_protection_add'),
    ...
    path("seasonality_report/", seasonality_report, name="seasonality_report"),
    path("export-seasonality-data/", export_seasonality_data, name="export-seasonality-data"),
    path("export_seasonality_data/", export_seasonality_data, name="export_seasonality_data"),
    path('absence-analysis/', absence_analysis, name='absence_analysis'),
    path('absence_analysis/', absence_analysis, name='absence-analysis'),
    path('export-absence-data/', export_absence_data, name='export_absence_data'),
    path('export_absence_data/', export_absence_data, name='export-absence-data'),
    path('employee-absence-details/<str:username>/', employee_absence_details, name='employee_absence_details'),
    path('employee_absence_details/<str:username>/', employee_absence_details, name='employee-absence-details'),
    path("weekday-analysis/", weekday_analysis, name="weekday-analysis"),
    path("weekday_analysis/", weekday_analysis, name="weekday_analysis"),
    path('time-distribution/', time_distribution, name='time_distribution'),
    path('time_distribution/', time_distribution, name='time-distribution'),
    path("export-time-distribution/", export_time_distribution, name="export-time-distribution"),
    path("export_time_distribution/", export_time_distribution, name="export_time_distribution"),
    ...
    path('training-debt-report/', views.training_debt_report, name='training_debt_report'),
    path('training-debt-report/export/', views.export_training_debt_excel, name='export_training_debt_excel'),

    # Доверенности
    path('poa/', PoaListView.as_view(), name='poa_list'),
    path('poa/add/', PoaCreateView.as_view(), name='poa_add'),
