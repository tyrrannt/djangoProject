...
urlpatterns = [
    ...
    path('api/push/vapid-key/', api_views.VapidKeyAPIView.as_view(), name='api_push_vapid_key'),
    ...
    path("staff/<int:pk>/set-email/", views.AssignCorporateEmailView.as_view(), name="staff_set_corporate_email"),
