...
def get_database_user():
    """Синхронизирует пользователей с 1С ЗУП через единый сервисный слой process_sync_database_users.

    Returns:
        dict: Результаты синхронизации пользователей и профилей.
    """
    from hrdepartment_app.services.celery_services import process_sync_database_users
    return process_sync_database_users()
