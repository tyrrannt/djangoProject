...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='access_right',
            field=models.ManyToManyField(blank=True, default=0, to='customers_app.accesslevel', verbose_name='права доступа'),
        ),
        migrations.AlterField(
            model_name='databaseuser',
            name='address',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='customers_app.address'),
        ),
        migrations.AlterField(
            model_name='databaseuser',
            name='corp_phone',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='corp', to='customers_app.phonenumber', verbose_name='корпоративный номер'),
        ),
        migrations.AlterField(
            model_name='databaseuser',
            name='gender',
        ...
        migrations.AlterField(
            model_name='databaseuser',
            name='phone',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cell', to='customers_app.phonenumber', verbose_name='номер телефона'),
        ),
        migrations.AlterField(
            model_name='databaseuser',
            name='type_users',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('juridical_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='juridical', to='customers_app.address', verbose_name='Юридический адрес')),
                ('phone', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='customers_app.phonenumber', verbose_name='Номер телефона')),
                ('physical_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='physical', to='customers_app.address', verbose_name='Физический адрес')),
            ],
        ),
    ]
