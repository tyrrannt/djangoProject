    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_ref_key',
                 models.CharField(default='', max_length=37, verbose_name='Уникальный номер физ лица')),
                ...
                ('type_users', models.CharField(blank=True, choices=[('natural_person', 'физическое лицо'),
                                                                     ('staff_member', 'штатный сотрудник'),
                                                                     ('freelancer', 'внештатный сотрудник')],
                                                default='', max_length=40, verbose_name='Тип пользователя')),
                ('personal_phone',
                 models.CharField(blank=True, default='', max_length=15, verbose_name='Личный номер телефона')),
                ('gender',
                 models.CharField(blank=True, choices=[('male', 'мужской'), ('female', 'женский')], default='',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_role',
                 models.CharField(blank=True, choices=[('1', 'НО'), ('2', 'Кадры'), ('3', 'Бухгалтерия')],
                                  max_length=11, null=True, verbose_name='Роль подразделения')),
                ('destination_point',
                 models.BooleanField(default=False, verbose_name='Используется как место назначения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ref_key', models.CharField(default='', max_length=37, verbose_name='Уникальный номер')),
                ('code', models.CharField(default='', max_length=9, verbose_name='Код')),
                ('name', models.TextField(verbose_name='Наименование')),
                ('frequency_inspection',
                 models.PositiveSmallIntegerField(default=0, verbose_name='Периодичность осмотров')),
                ('frequency_multiplicity',
                 models.PositiveSmallIntegerField(default=0, verbose_name='Кратность осмотров')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('documents_access_add',
                 models.BooleanField(default=False, verbose_name='Разрешение на создание договора')),
                ('documents_access_edit',
                 models.BooleanField(default=False, verbose_name='Разрешение на редактирование договора')),
                ('documents_access_agreement',
                 models.BooleanField(default=False, verbose_name='Право на публикацию договора')),
                ('contracts_access_add',
                 models.BooleanField(default=False, verbose_name='Разрешение на создание документа')),
                ('contracts_access_edit',
                 models.BooleanField(default=False, verbose_name='Разрешение на редактирование документа')),
                ('contracts_access_agreement',
                 models.BooleanField(default=False, verbose_name='Право на публикацию документа')),
                ('posts_access_add',
                 models.BooleanField(default=False, verbose_name='Разрешение на создание сообщения')),
                ('posts_access_edit',
                 models.BooleanField(default=False, verbose_name='Разрешение на редактирование сообщения')),
                ('posts_access_agreement',
                 models.BooleanField(default=False, verbose_name='Право на публикацию сообщения')),
                ('guide_access_add',
                 models.BooleanField(default=False, verbose_name='Разрешение на создание записи в справочнике')),
                ('guide_access_edit',
                 models.BooleanField(default=False, verbose_name='Разрешение на редактирование записи в справочнике')),
                ('guide_access_agreement',
                 models.BooleanField(default=False, verbose_name='Право на публикацию записи в справочнике')),
                ('contracts_access_view',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='contracts_view', to='customers_app.accesslevel',
                                   verbose_name='Уровень доступа к документам')),
                ('documents_access_view',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='documents_view', to='customers_app.accesslevel',
                                   verbose_name='Уровень доступа к договорам')),
                ('guide_access_view',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='guide_view', to='customers_app.accesslevel',
                                   verbose_name='Уровень доступа к справочникам')),
                ('posts_access_view',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='posts_view', to='customers_app.accesslevel',
                                   verbose_name='Уровень доступа к сообщениям')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_date_start', models.DateField(blank=True, null=True, verbose_name='Дата начала отображения')),
                ('post_date_end', models.DateField(blank=True, null=True, verbose_name='Дата окончания отображения')),
                ('post_divisions',
                 models.ManyToManyField(to='customers_app.division', verbose_name='Подразделения поста')),
                ('responsible', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excluded_standard_spelling',
                 models.BooleanField(default=True, verbose_name='Исключена из штатного расписания')),
                ('employment_function', models.CharField(default='', max_length=37, verbose_name='Трудовая функция')),
                ('right_to_approval', models.BooleanField(default=False, verbose_name='Имеет право на согласование')),
                ('harmful', models.ManyToManyField(blank=True, to='customers_app.harmfulworkingconditions',
                                                   verbose_name='Вредные условия труда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_phone',
                 models.CharField(blank=True, default='', max_length=3, verbose_name='Внутренний номер телефона')),
                ('work_phone',
                 models.CharField(blank=True, default='', max_length=15, verbose_name='Корпоративный номер телефона')),
                ('work_email', models.EmailField(default='', max_length=254, verbose_name='Рабочий email')),
                ('work_email_password',
                 models.CharField(blank=True, default='', max_length=50, verbose_name='Пароль от корпоративной почты')),
                ('divisions', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                ...
                ('job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                          to='customers_app.job', verbose_name='Должность')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citizenship', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                  to='customers_app.citizenships', verbose_name='Гражданство')),
                ('passport', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                  to='customers_app.identitydocuments', verbose_name='Паспорт')),
            ],
            options={
            ...
            fields=[
                ...
                ('type_counteragent', models.CharField(
                    choices=[('juridical_person', 'юридическое лицо'), ('physical_person', 'физическое лицо'),
                             ...
                             ('government_agency', 'государственный орган')], default='', max_length=40,
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                       to='customers_app.useraccessmode', verbose_name='Права доступа'),
        ),
        migrations.AddField(
            model_name='databaseuser',
            name='groups',
