    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_ref_key', models.CharField(default='', max_length=37, verbose_name='Уникальный номер физ лица')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_of_role', models.CharField(blank=True, choices=[('1', 'НО'), ('2', 'Кадры'), ('3', 'Бухгалтерия')], max_length=11, null=True, verbose_name='Роль подразделения')),
                ('destination_point', models.BooleanField(default=False, verbose_name='Используется как место назначения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency_inspection', models.PositiveSmallIntegerField(default=0, verbose_name='Периодичность осмотров')),
                ('frequency_multiplicity', models.PositiveSmallIntegerField(default=0, verbose_name='Кратность осмотров')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsible', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='responsible_person', to=settings.AUTH_USER_MODEL, verbose_name='Ответственное лицо')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_email_password', models.CharField(blank=True, default='', max_length=50, verbose_name='Пароль от корпоративной почты')),
