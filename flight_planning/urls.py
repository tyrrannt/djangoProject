...
urlpatterns = [
    ...
    path('weather/mpd/<int:mpd_id>/api/sync/', views.mpd_weather_sync_run_view, name='mpd_weather_sync_run'),
    path('weather/mpd/<int:mpd_id>/api/sync-status/<str:task_id>/', views.mpd_weather_sync_status_view, name='mpd_weather_sync_status'),
